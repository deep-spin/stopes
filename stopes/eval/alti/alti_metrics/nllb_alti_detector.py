...
def load_nllb_model(
    ...
    **kwargs,
    ...
    x = fairseq.hub_utils.from_pretrained(
        ...
        langs=langs.split(","),
        lang_pairs="/home/nunomg/llm-hallucination/fairseq/language_pairs_small_models.txt",
        ...
        beam=4,
        fp16=fp16,
        fixed_dictionary="/home/nunomg/llm-hallucination/fairseq/model_dict.128k.txt",
        # extra arguments
